"""Stereo rig manager for handling multiple stereo rigs, rectification, disparity computation, and 3D reconstruction."""
...
class StereoCam3D:
    def __init__(
        ...
        self.logger = logging.getLogger("backend.src.calibration.stereo.StereoCam3D")

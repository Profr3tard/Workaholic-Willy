...
from backend.src.geometry.matrix import position_quaternion_to_matrix
from backend.src.geometry.validation import validate_homogeneous_matrix

if TYPE_CHECKING:  # pragma: no cover - typing only
    from backend.src.calibration.extrinsics import Extrinsics
    from backend.src.geometry.pose import Pose
    from backend.src.geometry.transform import Transform

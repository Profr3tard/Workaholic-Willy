...
This module deliberately depends only on :mod:`numpy` so the geometry package
stays free of OpenCV, SciPy, and robotics-vendor imports.
"""
...
# Set constant for identity-quat

...
Wire format
-----------
The dictionaries are deliberately schema-versioned so that future
breaking changes (e.g. switching to WXYZ ordering, or storing
covariance) can be detected and rejected.

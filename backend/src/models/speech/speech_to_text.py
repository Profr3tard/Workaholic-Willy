...
from backend.config.schema.models.models_schema import SpeechToTextConfig
from backend.src.models._inference import (
    autocast_ctx,
    build_load_kwargs,
    finalize_model,
)
from backend.src.models.constants import MODELS_LOG_DIR, WHISPER_LOG_FILE
from backend.src.models.speech._poll import poll_until_text
...
class WhisperSpeechToText:
    ...
    def listen_once(
        ...
        *,
        ...
        within the bound. Previously this looped forever on silence, a mic
        failure, or persistently blank output (denial-of-progress).
        """

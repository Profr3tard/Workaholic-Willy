"""Shared runtime helpers for Workaholic-Willy.

Small helpers are imported eagerly. Torch-dependent device helpers are
loaded lazily so importing ``backend.src.utility.unit_scaling`` never

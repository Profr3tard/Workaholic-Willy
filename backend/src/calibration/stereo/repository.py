...
from .sub_modules.map_store import StereoMapStore
...
class StereoRigRepository:
    ...
    def __init__(self, store: StereoMapStore | None = None):
        self.store = store if store is not None else StereoMapStore()

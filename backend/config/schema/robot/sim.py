...
class SimConfig(StrictModel):
    ...
    # TCP offset (mm) flange->grasp-centre; mirrors SimRobotConfig.tcp_offset_mm (forwarded by the
    # runtime converter). Driver-relevant -> goes through to the driver dataclass.
    tcp_offset_mm: float = Field(default=0.0, ge=0.0)
    headless: bool = True
